...
class Trainer(object):
    def __init__(self, model, ds_train, ds_val, ds_info, run_paths,model_name , total_steps, log_interval, ckpt_interval,learning_rate,patience, model_save_dir):
        ...
        # Loss objective, Optimizer, Model
        self.loss_object = tf.keras.losses.CategoricalCrossentropy()
        self.lr = tf.keras.optimizers.schedules.ExponentialDecay(learning_rate, 500, 0.9)
        ...
        self.bst_manager = tf.train.CheckpointManager(self.bst_checkpoint, directory="diabetic_retinopathy/checkpoints/best_ckpt/"+ model_name, max_to_keep=1)
    ...
    def train(self):
        ...
        for idx, (images, labels) in enumerate(self.ds_train):
            ...
            if step % self.log_interval == 0:
                ...
                #Early Stopping
                if self.val_loss.result().numpy()  < best_val_acc:
                        self.wait= 1
                        best_val_acc = self.val_loss.result().numpy()
